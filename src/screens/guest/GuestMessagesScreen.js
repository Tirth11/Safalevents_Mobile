  ...
  return (
    <Screen>
      ...
      {active === 'conversations' ? (
                ...
                <Row>
                  ...
                  <View style={{ flex: 1, paddingHorizontal: spacing.md }}>
                    <Row style={styles.between}>
                      <Text style={[font.body, { fontWeight: '700', flex: 1 }]} numberOfLines={1}>
                        {c.hostName}
                      </Text>
                      {c.unread ? <Ionicons name="ellipse" size={10} color={colors.red} style={{ marginLeft: spacing.sm }} /> : null}
                    </Row>
        ...
        outbox.map((o) => (
          <Card key={o.id} style={{ marginBottom: spacing.lg }}>
            <Row style={styles.between}>
              <Badge tone={CHANNEL_TONE[o.channel] || 'gray'} label={o.channel} />
              <Text style={[font.tiny, { marginLeft: spacing.sm }]}>{o.time}</Text>
            </Row>
            <Text style={[font.body, { fontWeight: '700', marginTop: spacing.sm }]} numberOfLines={1}>
              {o.subject}
            </Text>
